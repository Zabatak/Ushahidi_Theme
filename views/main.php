...
<div class="content-container">
    ...
    <div class="content-block content-blocks clearingfix" id="press-logos">
        ...
        <img src="<?php echo url::file_loc('img') . "media/img/logos/3in_logo.jpg" ?>" />
        <img src="<?php echo url::file_loc('img') . "media/img/logos/acutimes.jpg" ?>" />
        <img src="<?php echo url::file_loc('img') . "media/img/logos/al masry al youm_logo.jpg" ?>" />
        <img src="<?php echo url::file_loc('img') . "media/img/logos/cbc_logo.jpg" ?>" />
        
        <img src="<?php echo url::file_loc('img') . "media/img/logos/al rahma_logo.jpg" ?>" />
        
        <a title="برنامج عز الشباب" href="https://www.youtube.com/watch?v=s5kiRSBTvSQ&feature=BFa&list=PL56CBED9A80EC8CE8&lf=mh_lolz">
        <img src="<?php echo url::file_loc('img') . "media/img/logos/ezz elshabab_logo.jpg" ?>" />
		</a>
		<a title="Mashallah News" href="http://blog.zabatak.com/zabatak-in-mashallanews/">
        <img src="<?php echo url::file_loc('img') . "media/img/logos/Mashallah_Logo.png" ?>" />
		</a>
        <img src="<?php echo url::file_loc('img') . "media/img/logos/misr25_logo.jpg" ?>" />
        <img src="<?php echo url::file_loc('img') . "media/img/logos/youm7_logo.jpg" ?>" />
		
        <a title="ON TV" href="https://www.youtube.com/watch?v=9--arSWItyc&feature=BFa&list=PL56CBED9A80EC8CE8&lf=mh_lolz">
		<img src="<?php echo url::file_loc('img') . "media/img/logos/on_tv_logo.png" ?>" />
		</a>
		
		<a title="TedXTanta" href="https://www.youtube.com/watch?v=3FQyRsx-dNY&feature=BFa&list=PL56CBED9A80EC8CE8&lf=mh_lolz">
        <img src="<?php echo url::file_loc('img') . "media/img/logos/TEDxTanta_logo.png" ?>" />
		</a>
        
        
        <img src="<?php echo url::file_loc('img') . "media/img/logos/Cairo_ICT_logo.jpg" ?>" />
        <img src="<?php echo url::file_loc('img') . "media/img/logos/eed_logo.jpg" ?>" />
        
        <img src="<?php echo url::file_loc('img') . "media/img/logos/190328_10150113049035838_590230837_6591559_6632911_n.jpg" ?>" />
        <a title="الجزيرة مباشر" href="http://www.youtube.com/watch?v=tQ8mcxquKDE&list=PL56CBED9A80EC8CE8">
		<img src="<?php echo url::file_loc('img') . "media/img/logos/aljazeera_mu_logo.jpg" ?>" />
		</a>
        ...
        <img src="<?php echo url::file_loc('img') . "media/img/logos/big-masriya.jpg" ?>" />
		</a>
        <img src="<?php echo url::file_loc('img') . "media/img/logos/imagesCA5Y7QXC.jpg" ?>" />
        <img src="<?php echo url::file_loc('img') . "media/img/logos/m.jpg" ?>" />
		<a title="قناة النيل الثقافية" href="http://www.youtube.com/watch?v=yDxIc1744LY">
        <img src="<?php echo url::file_loc('img') . "media/img/logos/nile_sakafia.jpg" ?>" />
		</a>
        <a title="برنامج العاشرة مساءا" href="http://www.youtube.com/watch?v=g7q-5Rdb-Uc">
		<img src="<?php echo url::file_loc('img') . "media/img/logos/P6O55772.jpg" ?>" />
		</a>
        ...
        <img src="<?php echo url::file_loc('img') . "media/img/logos/t_2.jpg" ?>" />
		</a>
		...
		<img src="<?php echo url::file_loc('img') . "media/img/logos/horya.jpg" ?>" />
		</a>
