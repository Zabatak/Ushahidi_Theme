        ...
        <div class="big-block">
            ...
            <div class="report_left">
                <div class="report_row">
                    ...
                    <?php } ?>
                    <h4><?php echo Kohana::lang('ui_main2.reports_title'); ?> <span class="required">*</span> </h4>
                    <?php print form::input('incident_title', $form['incident_title'], ' class="text long"'); ?>
                    <p class="hint"><?php echo Kohana::lang('ui_main2.reports_title_hint'); ?></p>
                </div>
                <div class="report_row">
                    ...
                    <p class="hint"><?php echo Kohana::lang('ui_main2.incident_description_hint'); ?></p>
                </div>
                <div class="report_row" id="datetime_default">
                    <h4>
                        <?php echo Kohana::lang('ui_main2.reports_date_title'); ?>
                    </h4>
                    <p class="hint"><?php echo Kohana::lang('ui_main2.reports_date_hint'); ?></p>
                </div>
...
$columns = 2;
echo zcategory::tree($categories, $selected_categories, 'incident_category', $columns);
?>
                    </div>
                </div>
...
?>
                ...
                <div class="report_optional">
                    ...
                    <p class="hint"><?php echo Kohana::lang('ui_main2.reports_optional_hint'); ?></p>
                    <div class="report_row">
                        <h4><?php echo Kohana::lang('ui_main2.reports_person_name'); ?></h4>
<?php print form::input('person_first', $form['person_first'], ' class="text long"'); ?>
                    ...
                    -->
                    <div class="report_row">
                        <h4><?php echo Kohana::lang('ui_main2.reports_phone'); ?></h4>
...
<?php endif; ?>
                <div class="report_row">
                    <p class="hint"><?php echo Kohana::lang('ui_main2.reports_map_hint'); ?></p>
...
?>
                ...
                <div id="divPhoto" class="report_row">
                    ...
                    <p class="hint"><?php echo Kohana::lang('ui_main2.reports_photos_hint'); ?></p>
                    <?php
                    $this_div = "divPhoto";
